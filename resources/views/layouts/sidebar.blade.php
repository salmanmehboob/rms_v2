  ...
  <div class="deznav">
      <div class="deznav-scroll">
          <ul class="metismenu" id="menu">
              ...
              <li class="{{ Route::is('home', 'management.dashboard', 'item.categories.index') ? 'mm-active' : '' }}">
                  ...
                  <ul aria-expanded="true">
                      ...
                      <li
                          class="{{ Route::is('management.dashboard', 'item.categories.index' ,  'items.index', 'expense.categories.index' ,  'expenses.index') ? 'mm-active' : '' }}">
                          <a href="{{ route('management.dashboard') }}"
                              class="{{ Route::is('management.dashboard', 'item.categories.index', 'items.index', 'expense.categories.index' ,  'expenses.index') ? 'mm-active' : '' }}">Management
                              Dashboard</a>
              ...
              <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                  ...
                  <ul aria-expanded="false">
                      <li><a href="chat.html">Add customer</a>
                      </li>
                      <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Membership customers</a>

                      </li>
                      <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Non-Membership</a>
              ...
              <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                  ...
                  <ul aria-expanded="false">
                      <li><a href="ui-accordion.html">All Ordrs</a></li>
                      <li><a href="ui-alert.html">Daily Orders</a></li>
                  </ul>
              </li>
              <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                      <div class="menu-icon">
                  ...
                  <ul aria-expanded="false">
                      <li><a href="uc-select2.html">All Employees</a></li>
                      <li><a href="uc-nestable.html">Add Employee</a></li>
                  </ul>
              </li>
              ...
              <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                  ...
                  <ul aria-expanded="false">
                      <li><a href="table-bootstrap-basic.html">All Salaries</a></li>
                      <li><a href="table-datatable-basic.html">Add Salary</a></li>
                  </ul>
              </li>
              ...
              <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                  ...
                  <ul aria-expanded="false">
                      <li><a href="page-login.html">All Expenses</a></li>
                      <li><a href="page-register.html">Add Expense</a></li>
                  </ul>
              </li>
          </ul>
      </div>
